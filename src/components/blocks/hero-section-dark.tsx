          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link to="/onboarding" className="inline-block">
                <div className="inline-flex items-center space-x-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-5 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 transform shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-purple-700">
